...
namespace Xyz.Xrm.Entities
{
	...
	public partial class LeadAddress : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Xyz.Xrm.Entities.Lead lead_addresses
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Lead>("lead_addresses", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lead_addresses");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Lead>("lead_addresses", null, value);
		...
		public Xyz.Xrm.Entities.SystemUser lk_leadaddress_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_leadaddress_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_leadaddress_createdonbehalfby");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_leadaddress_createdonbehalfby", null, value);
		...
		public Xyz.Xrm.Entities.SystemUser lk_leadaddress_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_leadaddress_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_leadaddress_modifiedonbehalfby");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SystemUser>("lk_leadaddress_modifiedonbehalfby", null, value);
		...
		public Xyz.Xrm.Entities.SystemUser lk_leadaddressbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		public Xyz.Xrm.Entities.SystemUser lk_leadaddressbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
		...
		public Xyz.Xrm.Entities.TransactionCurrency TransactionCurrency_LeadAddress
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.TransactionCurrency>("TransactionCurrency_LeadAddress", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_LeadAddress");
				this.SetRelatedEntity<Xyz.Xrm.Entities.TransactionCurrency>("TransactionCurrency_LeadAddress", null, value);
