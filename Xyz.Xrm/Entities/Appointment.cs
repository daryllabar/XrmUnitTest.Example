...
namespace Xyz.Xrm.Entities
{
	...
	public partial class Appointment : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Xyz.Xrm.Entities.AppointmentState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Xyz.Xrm.Entities.AppointmentState)(System.Enum.ToObject(typeof(Xyz.Xrm.Entities.AppointmentState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Xyz.Xrm.Entities.Incident Incident_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Incident>("Incident_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Incident_Appointments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Incident>("Incident_Appointments", null, value);
		...
		public Xyz.Xrm.Entities.Lead Lead_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Lead>("Lead_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Lead_Appointments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Lead>("Lead_Appointments", null, value);
		...
		public Xyz.Xrm.Entities.msdyn_processnotes msdyn_processnotes_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.msdyn_processnotes>("msdyn_processnotes_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("msdyn_processnotes_Appointments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.msdyn_processnotes>("msdyn_processnotes_Appointments", null, value);
		...
		public Xyz.Xrm.Entities.Opportunity Opportunity_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Opportunity>("Opportunity_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Opportunity_Appointments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Opportunity>("Opportunity_Appointments", null, value);
		...
		public Xyz.Xrm.Entities.SalesOrder SalesOrder_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.SalesOrder>("SalesOrder_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("SalesOrder_Appointments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.SalesOrder>("SalesOrder_Appointments", null, value);
		...
		public Xyz.Xrm.Entities.Site site_Appointments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Xyz.Xrm.Entities.Site>("site_Appointments", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("site_Appointments");
				this.SetRelatedEntity<Xyz.Xrm.Entities.Site>("site_Appointments", null, value);
