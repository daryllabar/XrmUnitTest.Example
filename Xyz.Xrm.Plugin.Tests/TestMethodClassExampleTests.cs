    ...
    public class TestMethodClassExampleTests
    {
        ...
        private class CreationOfEntity_Should_DefineName : TestMethodClassBase
        {
            private struct Ids
            {
                ...
                public static readonly Id<Contact> Contact = new Id<Contact>("08ABE111-D02D-46C7-B6FA-1FD0177CDAA4");
            }
            ...
            protected override void Test(IOrganizationService service)
            {
                ...
                Assert.IsNotNull(service.GetEntity(Ids.Contact).FullName, "Full Name should have been defaulted.");
        ...
        private class CreationOfEntity_Should_RequireIdDefined : TestMethodClassBase
        {
            private struct Ids
            {
                ...
                public static readonly Id<Contact> Contact = new Id<Contact>("83F924AA-D3D5-4953-9453-631221DE7581");
            }
            ...
            protected override void Test(IOrganizationService service)
            {
                ...
                service.Create(new Contact());  // No Id populated, but WithIdsDefaultedForCreate, lists it as a value
                try
                {
                    service.Create(new Contact()); // Not valid since only one Lead Id has been pre-defined.
                }
                catch (Exception ex)
                {
                    //
        ...
        private class TraceMessageCreated_Should_BeAccessible : TestMethodClassBase
        {
            protected override void Test(IOrganizationService service)
            {
                ...
                // Assert
                //
                Assert.IsTrue(Logs.Any(l => l.Trace == "The target did not update to a non-null value for at least one of the following columns: address1_line1, address1_line2, address1_line3, address1_addresstypecode, address1_city, address1_country, address1_county, address1_stateorprovince, address1_name, address1_postalcode!"));
